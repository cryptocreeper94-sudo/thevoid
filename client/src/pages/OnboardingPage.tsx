...
const slides: Slide[] = [
  {
    ...
    category: "Welcome",
    title: "THE VOID",
    subtitle: "Built for letting it out.",
  ...
  },
  {
    ...
    category: "Vent",
    title: "Voice Venting",
    subtitle: "The core of everything.",
    description: "This is why we exist. Record your frustrations, rant out loud, say what you can't say anywhere else. AI listens and responds with the personality you choose — Smart-Ass, Calming, Therapist, Hype Man, or Roast Master.",
    icon: Mic,
    color: "text-cyan-400",
  ...
  },
  {
    ...
    subtitle: "Your vents become art.",
    description: "AI transforms the emotions from your venting sessions into unique abstract artwork. Each portrait evolves as you interact — a living painting of your emotional landscape.",
    icon: Palette,
    color: "text-pink-400",
  ...
  },
  {
    ...
    description: "After you vent, capture a message for your future self. Set a delivery date and the void holds your words until the right moment — so future you can see how far you've come.",
    icon: Timer,
