...
import { Settings, Sparkles, Brain, Zap, Heart, Volume2, Type, Palette } from "lucide-react";
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="relative z-10 flex flex-col gap-2">
                            <div className={`p-2 rounded-lg w-fit transition-colors ${isSelected ? "bg-white/20 text-white" : "bg-white/5 text-white/60"}`}>
                              <Icon className="w-4 h-4" />
                            </div>
                            <div>
                              <h3 className={`text-sm font-medium ${isSelected ? "text-white" : "text-white/80"}`}>{p.label}</h3>
